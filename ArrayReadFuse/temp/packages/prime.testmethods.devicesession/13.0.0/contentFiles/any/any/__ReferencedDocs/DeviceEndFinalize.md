...
## **Verify**
:large_blue_diamond: Fails if both EVG Brita and PRIME Brita is enabled  
...
The image below ilustrates the order requiremetns for the Evergreen and Prime instances to correctly <font size="3"><span style="color:OrangeRed">Finalize</font> the <font size="3"><span style="color:OrangeRed"> Device </font> testing session in the libraries.
