...
<table>
 ...
 <tr>
  ...
  <span style="color:GREEN;  font-weight: bold">FAIL_ONLY</span> prints to Ituff only fail result.<br>
	...
	<span style="color:GREEN;  font-weight: bold">ALL_DATA_PINMAP_COMPRESS</span> print all result in ituff compress format with pinMapId.<br>
  <span style="font-weight: bold">NOTE</span>: Refer to <a href="../../../../BusinessLogic/Dc/Readme.md">DC BusinessLogic</a> Wiki for more detail.
  </td>
 </tr>
 <tr>
