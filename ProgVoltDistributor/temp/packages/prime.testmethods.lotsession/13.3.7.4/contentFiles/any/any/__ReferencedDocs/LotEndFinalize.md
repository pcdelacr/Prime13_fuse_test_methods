...
The image below ilustrates the order requiremetns for Prime instances to correctly <font size="3"><span style="color:OrangeRed">Finalize </font> the <font size="3"><span style="color:OrangeRed"> Lot </font>testing session in the libraries.
