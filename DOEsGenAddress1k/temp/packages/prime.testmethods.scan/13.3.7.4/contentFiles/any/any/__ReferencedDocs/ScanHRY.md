...
![image.png](../.attachments/ScanHry/image-a300e8d1-4d28-4fe7-9f71-c70d272a4bd6.png)
...
| SharedStorageHRYExportKey  | No            | String               | Key for exporting HRY to SharedStorage IP scope. The key will be reset in all cases at beginning of execution with empty string. In case of failure, nothing will be written afterwards.  |                        |
...
| Aug 4<sup>th</sup>, 2024 | 12.3.1 | Wajde Dakwar | Updating documentation to include SharedStorageHRYExportKey parameter. |
