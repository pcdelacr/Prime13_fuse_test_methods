...
![image.png](./.attachments/ArrayRepairHighLevel.png)
...
![image.png](./.attachments/RepairBlock.png)
...
![image.png](./.attachments/Console2.png)
...
For detail explanation of the default repair algorithm (array redundancy), please click the [download link](./.attachments/DefaultRepairAlgorithm.pptx).
