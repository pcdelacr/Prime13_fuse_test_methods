...
passBinFound--> |Yes|SaveAssociatedValues[Save associated fact bin to the shared storage]--> PASS --> End(End)
...
| SspecBinsMappingKey  | Yes           |  String         | Shared storage key where the SspecBinsMapping object, which is a comma delimited string of passBin:sspec:factBin, is stored. | Allowed values: "LOT" or "DUT".   |
