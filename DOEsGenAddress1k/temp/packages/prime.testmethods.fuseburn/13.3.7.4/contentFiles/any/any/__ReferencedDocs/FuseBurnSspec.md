...
## FuseBurnSSPEC Structure JSON File Example
[Download](./.attachments/FuseBurnSspec/FuseBurnSspecSample.json)
```json
{
    "Configurations": [																				
        {
...
[<span style="color:green;font-size:2em">**Click to Download SspecParser**</span>](./.attachments/FuseBurnSspec/SspecParser.zip)
...
![image.png](./../.attachments/FuseBurnSspec/FuseBurnTestMethod-Verify-Flow.png)
...
![image.png](./../.attachments/FuseBurnSspec/FuseBurnTestMethod-Execute-Flow.png)
...
[Download](./.attachments/FuseBurnSspec/MiniFlowUserReferenceBurnSspec.cs)
...
|ULTEncode() |Execute ULTEncode with information provided in configuration file.<br>[Detail at FuseBurn General Information page](#general-fuseburn-information)<br>The encoded string will be stored to the configured storage.<br><font color="red">This API must use with SspecBurn.</font> |Bool. True for no execution error. If an execution error occurs, a test method exception will be thrown, immediately stopping the miniflow and test method, and exiting through port 0. |
|SspecBurn() |Same as FuseBurn ExecuteSspec. User is required to setup sspec information in configuration file. |Bool. True for no execution error, will throw exception if there is error during execution. |
...
Test PrimeFuseBurnSSPECTestMethod DynamicSspec_Fullstring_MultiRegisters_DatalogBinary_SkipPatternExecuteDisabled_P1
{
	ConfigurationFile = "~HDMT_TPL_DIR/Modules/FuseBurn/FuseBurn/InputFiles/scenario5_sspec.fuseBurn.json";ss
	ConfigName = "Config5DynamicSspec"; #USER TODO: define value
	RegisterNames = "CPU0,PCH0"; #USER TODO: define value
...
| 13.02.00      | #53469               | Enable ULTEncode for MiniFlow. |
| 13.01.00      | #51636               | Store FinalFuseStringToBurn (GetFinalFuseStringToBurn) to sharedstorage. 
| 13.01.00      | #52204 #54830        | Remove Engineering Header and Console Printing. |
