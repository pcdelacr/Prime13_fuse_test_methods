...
passBinFound--> |Yes|SaveAssociatedValues[Save the associated sspec and fact bin to the shared storage]--> PASS --> End(End)
...
| SspecBinsMappingObjectKey  | Yes   |  String         | Shared storage key where the SspecBinsMapping object, which is a comma-delimited string of "passBin:sspec:factBin" formatted elements, is stored. |  |
