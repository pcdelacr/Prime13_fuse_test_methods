...
![image.png](./.attachments/FuncDc/image-dfb339d8-8a8b-46b5-8ec5-5b3b34b2ef1d.png)
...
| ApplyTestConditionOptions | No     | String (choice) | Apply test condition option for Dc test with default option as WithoutSmartTestCondition.          | Default value - WithoutSmartTc              |
...
![image.png](./.attachments/FuncDc/image-7691ef1b-1f70-4ede-b3e7-7deebaf7f594.png)
...
![image.png](./.attachments/FuncDc/image-58d37d36-45c5-4a3e-a47f-21eb8ecda08b.png)
...
| Mar 20<sup>th</sup>, 2024 | 13.1.0          | Didier Jimenez Retana | Add new parameter ApplyTestConditionOptions to enable SmartTc in DcTest.<br> #48209 |