...
| DatalogLevel                 | No            | String (choice) | FAIL_ONLY(**default**), ALL, [COMPRESS](#Compress-Datalog-Output), PINMAP_COMPRESS, PIN_DETAIL, [METADATA](#METADATA), [METADATA_AVERAGE](#METADATA_AVERAGE)                                 | FAIL_ONLY - prints to Ituff only fail result.<br> ALL - prints both fail and pass results.<br> COMPRESS - print all result in ituff compress format.<br> PINMAP_COMPRESS - print all result in ituff compress format with pinMapId.<br> METADATA - Print all values with comma separated using SPM bussinessLogic.<br> METADATA_AVERAGE - Print the average value per pin using SPM bussinessLogic.<br>**NOTE**: For other than METADATA and METADATA_AVERAGE, refer to [DC BusinessLogic](../../../../BusinessLogic/Dc/Readme.md) Wiki for more detail.|
...
![image.png](./.attachments/TriggeredDc/image-6d1e304f-42ae-4487-bdd9-5b29b32a9bbf.png)

Failing case results printout

![image.png](./.attachments/TriggeredDc/image-6efa96d6-51d4-4ade-8d05-df80a19ec9fd.png)
...
```
### StringParsedMetadata datalog output
This testMethod use StringParsedMetadataHelper to write the results in ituff using two modes Metadata and Metadata_average.

#### METADATA
Metadata mode define two data separator, use bar simbol to separate the list of values per pin and comma to separate values of the same pin.

**Ituff format:**
```C#
4_uddtype_TOD_TDC<TestNamePostFixChunck>0_<pinA name>,<pinB name>,<pinC name>,...,<pinG name>   <-- NameDList column definition
4_uddtype_TOD_TDC<TestNamePostFixChunck>1_<pinH name>,<pinI name>,<pinJ name>,...,<pinM name>
4_uddtype_TOD_TDC<TestNamePostFixChunck>2_<pinN name>,<pinQ name>,<pinP name>,...,<pinZ name>
2_tname_<TestName>_All
2_msunit_SPMV1://[!TDC<TestNamePostFixChunck>#]|,//                                              <-- TDC is "trigger DC" and TestNamePostFixChunck is last chunk of testname splited by underscore
2_strgval_<VA1>,<VA2>,...,<VAn>|<VB1>,<VB2>,...,<VBn>|...|<VZ1>,<VZ2>,...,<VZn>                 <-- values per pin using '|' as separator and using ',' to separate values of the same pin.
2_tname_<TestName>_fc                                                                           <-- Composite section only will be printed if any dc result is failing
2_category_fc
2_composite_<pinA Channel>_<VAx>
2_composite_<pinB Channel>_<VBx>
                  ...
2_composite_<pinZ Channel>_<VZ1>                                                                <-- Each failed value per pin will be printed one value per line
2_composite_<pinZ Channel>_<VZ2>
2_composite_<pinZ Channel>_...
2_composite_<pinZ Channel>_<VZn>
```

**MTPL Example:**
```python
CSharpTest PrimeTriggeredDcTestMethod PrimeTriggeredDcTest_ItuffMetaData_longStrValWithFailures_P0
{
   Patlist = "dc_plist";
   LevelsTc = "Dc::SPM_TC";
   TimingsTc = "Dc::basic_func_timing_10MHz_20MHz";
   Pins = "DomainA_DPIN_PMU, DomainB_DPIN_PMU, all_VLC, all_LC, all_HC";
   MeasurementTypes = "V, V, C, C, C";
   LowLimits = "0V, 0V, 0.0A, 0.0A, -0.5A";
   HighLimits = "5V, 5V, 0.5A, 0.5A, 0.5A";
2_strgval_<VA_average_>|<VB_average>|...|<VZ_average>                                           <-- values per pin using '|' as separator between average values.
2_tname_<TestName>_fc                                                                           <-- Composite section only will be printed if any dc result is failing
2_category_fc
2_composite_<pinA Channel>_<VAx>
2_composite_<pinB Channel>_<VBx>
...
**MTPL Example:**
```python
CSharpTest PrimeTriggeredDcTestMethod PrimeTriggeredDcTest_ItuffMetaData_longStrVal_P1
{
   Patlist = "dc_plist";
   LevelsTc = "Dc::SPM_TC";
   TimingsTc = "Dc::basic_func_timing_10MHz_20MHz";
   ...
   TriggerMapName = "Dc::TriggerDCMap";
   LogLevel = "Enabled";
   DatalogLevel = "METADATA_AVERAGE";
}
```
**ituff Example of previos test:**
```
4_uddtype_TOD_TDCP10_xxHPCC_DPIN_PMU_slcA_Short,xxHPCC_DPIN_PMU_slcA_50ohm1,xxHPCC_DPIN_PMU_slcA_50ohm2,xxHPCC_DPIN_PMU_slcA_50ohm3,xxHPCC_DPIN_PMU_slcA_100ohm,xxHPCC_DPIN_PMU_slcA_200ohm,xxHPCC_DPIN_PMU_slcA_1Kohm,xxHPCC_DPIN_PMU_slcA_2Kohm,xxHPCC_DPIN_PMU_slcA_10Kohm,xxHPCC_DPIN_PMU_slcA_20Kohm,xxHPCC_DPIN_PMU_slcA_180Kohm,xxHPCC_DPIN_PMU_slcA_1Mohm1,xxHPCC_DPIN_PMU_slcA_1Mohm2,xxHPCC_DPIN_PMU_slcA_DiodeNeg,xxHPCC_DPIN_PMU_slcA_DiodePos,xxHPCC_DPIN_PMU_slcA_Open,xxHPCC_DPIN_PMU_slcB_Short,xxHPCC_DPIN_PMU_slcB_50ohm1,xxHPCC_DPIN_PMU_slcB_50ohm2,xxHPCC_DPIN_PMU_slcB_50ohm3,xxHPCC_DPIN_PMU_slcB_100ohm,xxHPCC_DPIN_PMU_slcB_200ohm,xxHPCC_DPIN_PMU_slcB_1Kohm,xxHPCC_DPIN_PMU_slcB_2Kohm,xxHPCC_DPIN_PMU_slcB_10Kohm
4_uddtype_TOD_TDCP11_xxHPCC_DPIN_PMU_slcB_20Kohm,xxHPCC_DPIN_PMU_slcB_180Kohm,xxHPCC_DPIN_PMU_slcB_1Mohm1,xxHPCC_DPIN_PMU_slcB_1Mohm2,xxHPCC_DPIN_PMU_slcB_DiodeNeg,xxHPCC_DPIN_PMU_slcB_DiodePos,xxHPCC_DPIN_PMU_slcB_Open,HDDPS_VLC_16ohm1,HDDPS_VLC_16ohm2,HDDPS_VLC_16ohm3,HDDPS_VLC_16ohm4,HDDPS_VLC_160ohm1,HDDPS_VLC_160ohm2,HDDPS_VLC_160ohm3,HDDPS_VLC_160ohm4,HDDPS_VLC_1600ohm1,HDDPS_VLC_1600ohm2,HDDPS_VLC_1600ohm3,HDDPS_VLC_1600ohm4,HDDPS_VLC_16Kohm1,HDDPS_VLC_16Kohm2,HDDPS_VLC_16Kohm3,HDDPS_VLC_16Kohm4,HDDPS_LC_gangx2_2p5ohm1,HDDPS_LC_gangx2_2p5ohm2
4_uddtype_TOD_TDCP12_HDDPS_LC_nogang_5ohm1,HDDPS_LC_nogang_5ohm2,HDDPS_LC_nogang_12ohm1,HDDPS_LC_nogang_12ohm2,HDDPS_LC_nogang_250ohm1,HDDPS_LC_nogang_250ohm2,HDDPS_HC_gangx2_0p075ohm1,HDDPS_HC_gangx2_0p075ohm2,HDDPS_HC_nogang_5ohm1,HDDPS_HC_nogang_5ohm2,HDDPS_HC_nogang_12ohm1,HDDPS_HC_nogang_12ohm2,HDDPS_HC_nogang_250ohm1,HDDPS_HC_nogang_250ohm22_tname_Dc::PrimeTriggeredDcTest_ItuffMetaData_longStrVal_P1_All
2_msunit_SPMV1://[!TDCP1#]|//
2_strgval_1.169991|0.39999|0.299988|0.199986|0.39999|0.299988|0.199986|0.39999|0.299988|1.199989|0.39999|0.299988|1.199989|0.39999|0.299988|0.199986|1.199989|0.39999|0.299988|0.199986|0.39999|0.299988|0.199986|0.39999|0.299988|1.199989|0.39999|0.299988|1.199989|0.39999|0.299988|0.199986|0.1|0.0025|0.0027|0.004|0.0027|0.004|0.0025|0.0027|0.0025|0.0027|0.003|0.0025|0.003|0.0025|0.0027|0.004|0.1|0.0025|0.0025|0.0027|0.0027|0.003|0.004|0.0025|0.0025|0.0027|0.0025|0.0027|0.003|0.0025|0.0027|0.004
```
...
| May 24<sup>th</sup>, 2021 | 5.0         | Didier Armando Jimenez Retana | Allow the TriggeredDc test method to perform measurement type per Pin.<br> #14215 |
| Jun  9<sup>th</sup>, 2021 | 5.2         | Kevin D. Krake                | Adding pin mask ability                                                                                                             |
| Sep 17<sup>th</sup>, 2021 | 6.1         | Didier Armando Jimenez Retana | Adding Compress and PinMapCompress Datalog mode.<br> #16595 |
| Oct  1<sup>st</sup>, 2021 | 7.0         | Didier Armando Jimenez Retana | Adding Pcat Datalog mode.<br> #16373 |
| Nov 15<sup>th</sup>, 2021 | 7.1         | Gadeer Awaisy                 | Allow user to override PrintToDatalog                                                                                               |
| Feb  4<sup>th</sup>, 2022 | 8.1         | Didier Armando Jimenez Retana | Implement the PatternTriggerMap alephable.<br> #23606 |
| Mar 17<sup>th</sup>, 2022 | 9.0         | Kevin D Krake                 | Adding new Results method for exit port handling         
| Nob  3<sup>rd</sup>, 2022 | 12          | Didier Armando Jimenez Retana | Expose SoftwareTriggerSettings in test method extensions.<br> #31418 |
| Sep 13<sup>th</sup>, 2023 | 12.02.02    | Teoh, Khai Jie                | include fail pin name and fail channel printing to ituff. #39827 |                                                                                                   |
| Nov  8<sup>th</sup>, 2023 | 13.00.00    | Yusof, Adam Malik             | PrimeTriggeredDcTestMethod: unable to set capture fail modes.<br> #45084 |
...
| Jul  2<sup>sd</sup>, 2024 | 13.01.00    | Didier Armando Jimenez Retana | Add MetaData datalog output.<br> #46496 |