...
![Datalog1.png](./.attachments/Datalog1.png)
...
![Datalog2.png](./.attachments/Datalog2.png)
...
![Datalog3.png](./.attachments/Datalog3.png)
...
![Datalog4.png](./.attachments/Datalog4.png)
...
```c++
        ...
        {
            // Customize code
            Prime.Services.ConsoleService.PrintDebug($"this message is from marginsweep CustomDatalogFuseStringByFuseGroupName.");
