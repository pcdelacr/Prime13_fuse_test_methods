...
EXEC : P1 : STRING : EXPRESSION : ExecCallback('PrimeMemorySnapshot', 'MyCustomPostFix')   : - : - : - : - : P2 : 2
EXEC : P2 : STRING : EXPRESSION : ExecCallback('PrimeExecuteTestInstance', 'InstanceName') : - : - : - : - : 1  : 2
END_SCREEN
```
...
| SkipItuffErrorLogging | No            | String (choice) | Enabled, <br> Disabled (**default**).           | Allows skipping extra ituff and console printing, such as messages indicating when a key is not found in the SharedStorage|
----  
...
| Apr 4<sup>th</sup>, 2025  | 13.02.01    | Maria N Rojas | Adding parameter to skipp ituff and console extra printing |
