...
<span style="font-weight: bold; color:red">Note:</span> Any test condition that Apply with SmartTcCategroy <span style="font-weight: bold; color:red">NONE</span> will flush all smart tc categories.
List of test condition that will Apply with SmartTcCategory <span style="font-weight: bold; color:red">NONE</span>:
- GetTestCondition("testConditionName", this.sessionContext).Apply();
- GetTestCondition("testConditionName", this.sessionContext).Apply(SmartTcCategoryType.NONE);
- GetTestCondition("testConditionName", this.sessionContext).ForceApply();
- GetTestCondition("testConditionName", this.sessionContext).ForceApply(SmartTcCategoryType.NONE);
- GetTestCondition("testConditionName", SmartTcCategoryType.NONE, this.sessionContext).Apply();
- GetTestCondition("testConditionName", SmartTcCategoryType.NONE, this.sessionContext).Apply(SmartTcCategoryType.NONE);
- GetTestCondition("testConditionName", SmartTcCategoryType.NONE, this.sessionContext).ForceApply();
- GetTestCondition("testConditionName", SmartTcCategoryType.NONE, this.sessionContext).ForceApply(SmartTcCategoryType.NONE);
- GetTestCondition("testConditionName", <SmartTcCategoryType <span style="font-weight: bold; color:red">other than NONE</span>>, this.sessionContext).Apply(SmartTcCategoryType.NONE);
- GetTestCondition("testConditionName", <SmartTcCategoryType <span style="font-weight: bold; color:red">other than NONE</span>>, this.sessionContext).ForceApply();
- GetTestCondition("testConditionName", <SmartTcCategoryType <span style="font-weight: bold; color:red">other than NONE</span>>, this.sessionContext).ForceApply(SmartTcCategoryType.NONE);
- CreateDirectTestCondition("testConditionName, <TestConditionType>, this.sessionContext).Apply();
- CreateDirectTestCondition("testConditionName, <TestConditionType>, this.sessionContext).Apply(SmartTcCategoryType.NONE);
- CreateDirectTestCondition("testConditionName, <TestConditionType>, this.sessionContext).ForceApply();
- CreateDirectTestCondition("testConditionName, <TestConditionType>, this.sessionContext).ForceApply(SmartTcCategoryType.NONE);
