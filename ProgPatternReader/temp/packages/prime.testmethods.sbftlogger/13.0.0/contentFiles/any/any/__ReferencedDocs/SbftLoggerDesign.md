...
![image.png](./.attachments/ArrayFusingHighLevel.png)
...
![image.png](./.attachments/ArrayFusingAndArrayRepairOverall.png)
...
### Execute
  ...
  - Import Solution - 3 modes to import solution from:
...
For detail explanation of fuse bit string, please click the [download link](./.attachments/ArrayFusing.pptx).
...
| FusingMode         | Yes           | String (choice) | RESET_ALL_RESOURCES, IMPORT_SOLUTION_FROM_DFF_AND_APPLY, IMPORT_SOLUTION_FROM_ARRAYREPAIR_AND_APPLY |                                    |
...
![image.png](./.attachments/Console1.png)
