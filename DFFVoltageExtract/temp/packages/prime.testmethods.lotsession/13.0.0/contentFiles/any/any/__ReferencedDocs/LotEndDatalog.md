...
The image below ilustrates the order requiremetns for the Evergreen and Prime instances in order to generate correctly the ITUFF <font size="3"><span style="color:OrangeRed">Lot </font> testing session <font size="3"><span style="color:OrangeRed">Footer</font>.
